...
export default function PricingHero() {
  ...
  useEffect(() => {
    ...
    tl.from(imageRef.current, { scale: 1.2, opacity: 0, duration: 1.8, ease: 'power2.out' })
      ...
      .from(paragraph.words, { yPercent: 120, ease: 'circ.out', duration: 1, stagger: 0.018 }, '<0.6')
  ...
  return (
    ...
    >
      ...
      <img
        ref={imageRef}
        src={stockImages.installation15}
        alt={t('imageAlt')}
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl">
        ...
        <h1
          ref={titleRef}
          className="pricing-hero-split mt-5 max-w-3xl font-display text-[clamp(2.25rem,7.2vw,5rem)] font-extrabold leading-[1.02] tracking-tight text-linen-50"
        >
          {t('title')}
        </h1>
        <p
          ref={paragraphRef}
          className="pricing-hero-split mt-6 max-w-xl text-base leading-relaxed text-linen-50/70"
        >
          {t('subtitle')}
        </p>
