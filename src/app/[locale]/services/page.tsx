...
export default async function ServicesPage({
  ...
  const extendedItems = t.raw('extended.items') as { title: string; body: string }[];
  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        ...
        <ul className="mt-10 divide-y divide-amber-100 border-y border-amber-100">
        ...
        <p className="mt-6 text-sm text-ink/60">{t('extended.note')}</p>
      </section>
    </>
  );
}
